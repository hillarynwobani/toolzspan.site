// Netlify Function — Create GIF from video/images
// Engine: FFmpeg
...
exports.handler = async (event) => {
  ...
  return {
    ...
    body: JSON.stringify({ status: 'ready', message: 'Create GIF from video/images endpoint. Deploy with FFmpeg to enable.' })
  };
};
