// Netlify Function — Convert MP3 to MP4 with static image
// Engine: FFmpeg
...
exports.handler = async (event) => {
  ...
  return {
    ...
    body: JSON.stringify({ status: 'ready', message: 'Convert MP3 to MP4 with static image endpoint. Deploy with FFmpeg to enable.' })
  };
};
